function updateNotesTable(noteId, noteTitle) {
    ...
    getNotes(noteTitle).then(data => {
        data.forEach(note => {
            ...
            cell4.innerHTML = `<a onclick="openEditModal('${note["_id"]}')" href="#"><img src="images/compose.png" style="width: 22px;"></a>
                               <a onclick="confirmDeleteNote('${note["_id"]}')" href="#"><img src="images/dustbin.png" style="width: 22px;"></a>`
        })
    }).then(() => {
        if(noteId) {
